...
<head>
	...
	<title>H&V PET CARE </title>

	<!-- Standard Favicon -->
	<link rel="icon" type="image/x-icon" href="images/H&V.ico" />
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-sm-8 col-xs-6">
							<p>Leave A Message: <a href="mailto:info@petcare.com">nhom8@HuyVu.com</a></p>
						</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3 logo-block pull-left">
							<a href="#">
								<img src="images/Ảnh chụp màn hình (309).png " alt="Logo" style="height: 80px; width:150px" />
							</a>
						</div>
						<div class="col-md-9 pull-right">
							<div class="location">
								<img src="images/icon/location-ic.png" alt="Location" />
								<p><span>Vị trí</span> Cao đẳng FPT,Hà Nội</p>
							</div>
							<div class="time-scheduled">
								<img src="images/icon/time-ic.png" alt="time" />
								<p><span>Thứ Hai - Thứ Bảy</span> 8:00 - 22:00</p>
							</div>
							<div class="phone">
								<img src="images/icon/phone-ic.png" alt="phone" />
								<p><span>Call Us</span> 0886024946</p>
							</div>
							<div class="cart">
								<a href="index.php?act=giohang"><img src="images/icon/cart-ic.png" alt="png" /></a>
							</div>
						</div>
					</div>
				</div><!-- Container /- -->
					...
					<div class="row">
						...
						<div id="navbar" class="navbar-collapse collapse">
							<ul class="nav navbar-nav">
								<li class="active"><a href="index.php?act=trangchu">Trang Chủ</a></li>
								<li><a href="index.php?act=about-us">Về Chúng Tôi</a></li>


								<li class="dropdown">
									<a href="shop.html" title="product list" class="dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false">Dịch vụ</a>
									...
									<ul class="dropdown-menu">
										...
										foreach ($listdichvu as $dichvu) {
											echo '<li><a href="index.php?act=  ' . $dichvu['MaDichVu'] . '">' . $dichvu['name'] . '</a></li>';
										}
										?>
									</ul>
								</li>
						...
						<?php if (isset($_SESSION['user'])) : ?>
							<a href="" class="username">Hello <?= $_SESSION['user'] ?> </a>
